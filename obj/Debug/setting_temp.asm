...
; global declarations
;--------------------------------------------------------
	global	_settingTemp_init
	global	_settingTemp_update
	global	_GET_settingTemp
	global	_GET_NOT_pressed_time

;--------------------------------------------------------
; global definitions
;--------------------------------------------------------
UD_setting_temp_0	udata
; Fsetting_temp_not_pressed_time_0_0 == .
_not_pressed_time	res	2

UD_setting_temp_1	udata
; Fsetting_temp_setting_temp_v_0_0 == .
_setting_temp_v	res	1
...
IDD_setting_temp_0	idata
; Fsetting_temp_one_second_time_0_0 == .
_one_second_time
	db	0x00	; 0


IDD_setting_temp_1	idata
; Fsetting_temp_flag_0_0 == .
_flag
	db	0x01	; 1


IDD_setting_temp_2	idata
; Fsetting_temp_SSD_data_0_0 == .
_SSD_data
	db	0x0a	; 10
...
;	  166+   72 =   238 instructions (  620 byte)
