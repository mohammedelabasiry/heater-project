...
; global declarations
;--------------------------------------------------------
	global	_Heating_Led_init
	global	_Heating_Led_Update
	global	_Set_Heating_Led
	global	_Get_Heating_Led
...
;--------------------------------------------------------
UDL_Heating_led_0	udata
r0x1004	res	1
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------

IDD_Heating_led_0	idata
; FHeating_led_one_second_time_0_0 == .
_one_second_time
	db	0x00	; 0


IDD_Heating_led_1	idata
; FHeating_led_heating_led_state_0_0 == .
_heating_led_state
	db	0x00	; 0
...
;	   60+   28 =    88 instructions (  232 byte)
